...
For a full guided tutorial, see [Getting Started](GETTING_STARTED.md).
...
See [Data Preparation](DATA_PREPARATION.md) for more detailed examples for `AnnData`, `MuData`, RNA+ATAC, and RNA+ADT studies.
...
|---|---|---|
| Tutorial | [Getting Started](GETTING_STARTED.md) | First complete run from notebook object to results. |
| How-To | [Data Preparation](DATA_PREPARATION.md) | Practical recipes for making data acceptable to mvexp. |
| How-To | [Migrate from v1 to v2](HOWTO_MIGRATE_V1_to_V2.md) | Move from the old manual workflow to the GUI and registry. |
| Reference | [Models Glossary](reference/MODELS_GLOSSARY.md) | Built-in model assumptions and hyperparameters. |
| Reference | [Evaluation Metrics](reference/EVALUATION_METRICS.md) | Bio-conservation and batch-correction metric definitions. |
| Explanation | [Architecture](ARCHITECTURE.md) | How the platform works internally. |
